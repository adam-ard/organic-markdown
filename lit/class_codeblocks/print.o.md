...
def print_help(self):
    ...
    print("  weave <dest>        render all .o.md files as HTML")
    print("  serve <dest>        weave and serve runnable documentation")
    print("")
...
omd_assert_regex(r"weave <dest>\s+render all \.o\.md files as HTML", output)
omd_assert_regex(r"serve <dest>\s+weave and serve runnable documentation", output)
