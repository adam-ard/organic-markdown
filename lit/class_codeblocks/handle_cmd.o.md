...
* `serve <dest>` — Weave and serve the HTML with runnable command cards
...
dispatcher.handle_cmd(["serve", "site"])
omd_assert("site", dispatcher.serve_dest)
```
